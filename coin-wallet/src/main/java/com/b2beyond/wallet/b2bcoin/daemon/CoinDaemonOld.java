 ...
 */
public class CoinDaemonOld extends AbstractDaemon {

    private Logger LOGGER = Logger.getLogger(this.getClass());
    private String daemonExecutable;


    public CoinDaemonOld(PropertiesConfiguration daemonProperties, String operatingSystem) {
        LOGGER.info("Starting old coin daemon for OS : " + operatingSystem);
        ...
        try {
            daemonExecutable = daemonProperties.getString("coin-daemon-old-" + operatingSystem);
            ...
            ProcessBuilder pb = new ProcessBuilder(binariesLocation + daemonExecutable, "--config-file", configLocation + "coin-old.conf",
