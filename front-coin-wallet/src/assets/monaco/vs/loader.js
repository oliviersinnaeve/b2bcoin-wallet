...
!function (e) {
    ...
    var r = function () {
        ...
        return r.prototype._createIgnoreDuplicateModulesMap = function () {
            ...
            var r, n = t;
            if (e.Utilities.endsWith(n, ".js") || e.Utilities.isAbsolutePath(n))e.Utilities.endsWith(n, ".js") || e.Utilities.containsQueryString(n) || (n += ".js"), r = [n]; else {
...
!function (e) {
    var t = function () {
        ...
        return e.prototype.load = function (e, t, r, n) {
            var o = this, i = {callback: r, errorback: n};
        ...
        return t.prototype._init = function (e) {
            ...
            } else n = e.Utilities.fileUriToFilePath(n), this._fs.readFile(n, {encoding: "utf8"}, function (a, c) {
            ...
            var r = this._crypto.createHash("md5").update(t, "utf8").digest("hex"), n = this._path.basename(t).replace(/\.js$/, "");
...
!function (e) {
    ...
    var s = function () {
        ...
        return s._findRelevantLocationInStack = function (e, t) {
            ...
            var r = this, n = this._moduleIdProvider.getStrModuleId(e), o = (this._inverseDependencies2[e] || []).map(function (e) {
                return r._moduleIdProvider.getStrModuleId(e)
            });
            return {errorCode: "load", moduleId: n, neededBy: o, detail: t}
            ...
            for (s.push(r), n[e] = !0; s.length > 0;) {
                var d = s.shift(), a = d.dependencies;
                if (a)for (var o = 0, i = a.length; o < i; o++) {
                    var u = a[o];
                    if (u.id === t)return !0;
            ...
            if (!this._modules2[t] && !this._knownModules2[t]) {
                ...
                var i = -1, s = function (n) {
                    if (i++, i >= o.length)r._onLoadError(t, n); else {
                        var d = o[i], a = r.getRecorder();
...
!function (e) {
    function t() {
        if (r = new e.ModuleManager(e.scriptLoader, n), e.isNode) {
            var t = e.global.require || require, s = function (n) {
