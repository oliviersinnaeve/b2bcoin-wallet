...
!function (e) {
    ...
    var r = monaco.Promise, i = 12e4, o = function () {
        function e(e) {
            var n = this;
        ...
        return Object.defineProperty(e.prototype, "edit", {
            ...
            if (l.is(e)) {
                ...
                if (!t) {
                    ...
                    this._workspaceEdit.changes.push(i), t = new c(r), this._textEditChanges[n.uri] = t
                }
                return t
            }
    ...
    !function (e) {
        ...
        e.create = n, e.is = t
    }(l = n.VersionedTextDocumentIdentifier || (n.VersionedTextDocumentIdentifier = {}));
    var g;
    !function (e) {
        function n(e, n, t, r) {
        ...
        e.create = n, e.is = t
    }(g = n.TextDocumentItem || (n.TextDocumentItem = {}));
    var m;
    !function (e) {
    ...
    }(m = n.CompletionItemKind || (n.CompletionItemKind = {}));
    var p;
    !function (e) {
        e.PlainText = 1, e.Snippet = 2
    }(p = n.InsertTextFormat || (n.InsertTextFormat = {}));
    var h;
    !function (e) {
        function n(e) {
            return {label: e}
        ...
        e.create = n
    }(h = n.CompletionItem || (n.CompletionItem = {}));
    var v;
    !function (e) {
        function n(e, n) {
        ...
        e.create = n
    }(v = n.CompletionList || (n.CompletionList = {}));
    var y;
    !function (e) {
        function n(e) {
        ...
        e.fromPlainText = n
    }(y = n.MarkedString || (n.MarkedString = {}));
    var b;
    !function (e) {
        function n(e, n) {
        ...
        e.create = n
    }(b = n.ParameterInformation || (n.ParameterInformation = {}));
    var _;
    !function (e) {
        function n(e, n) {
            for (var t = [], r = 2; r < arguments.length; r++)t[r - 2] = arguments[r];
        ...
        e.create = n
    }(_ = n.SignatureInformation || (n.SignatureInformation = {}));
    var C;
    !function (e) {
    ...
    !function (e) {
        ...
        e.create = n
    }(x = n.DocumentHighlight || (n.DocumentHighlight = {}));
    var I;
    !function (e) {
    ...
    !function (e) {
        ...
        e.create = n
    }(S = n.SymbolInformation || (n.SymbolInformation = {}));
    var k;
    !function (e) {
        function n(e) {
        ...
        e.create = n, e.is = t
    }(k = n.CodeActionContext || (n.CodeActionContext = {}));
    var w;
    !function (e) {
        function n(e, n) {
            var t = {range: e};
    ...
    !function (e) {
        ...
        e.create = n, e.is = t
    }(D = n.FormattingOptions || (n.FormattingOptions = {}));
    var K = function () {
        function e() {
        }
    ...
    n.DocumentLink = K, function (e) {
        ...
        e.create = n, e.is = t
    }(K = n.DocumentLink || (n.DocumentLink = {})), n.DocumentLink = K, n.EOL = ["\n", "\r\n", "\r"];
    var T;
    !function (e) {
        function n(e, n, t, r) {
        ...
        e.create = n, e.is = t
    }(T = n.TextDocument || (n.TextDocument = {}));
    var M;
    !function (e) {
    ...
    function o(e) {
        if (e)return new p(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1)
    }
    ...
    function d(e) {
        if (e && e.changes) {
            for (var n = [], t = 0, r = e.changes; t < r.length; t++)for (var i = r[t], a = 0, u = i.edits; a < u.length; a++) {
                var s = u[a];
                n.push({resource: m.parse(i.textDocument.uri), range: o(s.range), newText: s.newText})
            }
            return {edits: n}
        }
    }
    ...
    var g = e("vscode-languageserver-types"), m = monaco.Uri, p = monaco.Range, h = function () {
        function e(e, n) {
            var t = this;
        ...
        return e.prototype.dispose = function () {
            ...
            this._worker(e).then(function (n) {
                ...
                monaco.editor.setModelMarkers(monaco.editor.getModel(e), n, i)
            ...
            return l(t, this._worker(r).then(function (e) {
                ...
                if (e) {
                    var n = e.items.map(function (e) {
                        ...
                        return e.textEdit && (n.range = o(e.textEdit.range), n.insertText = e.textEdit.newText), e.insertTextFormat === g.InsertTextFormat.Snippet && (n.insertText = {value: n.insertText}), n
                    });
    ...
    var y = function () {
        ...
        return e.prototype.provideHover = function (e, n, t) {
            ...
            return l(t, this._worker(r).then(function (e) {
                ...
                if (e)return {range: o(e.range), contents: u(e.contents)}
            }))
        }, e
    }();
    n.HoverAdapter = y;
    ...
    var I = function () {
        ...
        return e.prototype.provideDocumentSymbols = function (e, n) {
            ...
            return l(n, this._worker(t).then(function (e) {
                ...
                if (e)return e.map(function (e) {
                    return {name: e.name, containerName: e.containerName, kind: f(e.kind), location: c(e.location)}
                })
            }))
        }, e
    }();
    ...
    var r = e("./workerManager"), i = e("./languageFeatures");
    n.setupMode = t
});