 ...
 * monaco-css version: 1.3.1(6787816d8e12533292fca5e861cc1769c775d1e7)
...
!function (e) {
    ...
    t.MultiLineStream = r;
    var i = "a".charCodeAt(0), o = "e".charCodeAt(0), s = "f".charCodeAt(0), a = "i".charCodeAt(0), l = "l".charCodeAt(0), c = "p".charCodeAt(0), d = "r".charCodeAt(0), h = "u".charCodeAt(0), p = "x".charCodeAt(0), m = "z".charCodeAt(0), u = "A".charCodeAt(0), f = "E".charCodeAt(0), g = "F".charCodeAt(0), b = "I".charCodeAt(0), y = "L".charCodeAt(0), w = "P".charCodeAt(0), v = "R".charCodeAt(0), x = "U".charCodeAt(0), k = "X".charCodeAt(0), T = "Z".charCodeAt(0), S = "0".charCodeAt(0), F = "9".charCodeAt(0), C = "~".charCodeAt(0), E = "^".charCodeAt(0), I = "=".charCodeAt(0), P = "|".charCodeAt(0), A = "-".charCodeAt(0), _ = "_".charCodeAt(0), D = "%".charCodeAt(0), R = "*".charCodeAt(0), O = "(".charCodeAt(0), z = ")".charCodeAt(0), N = "<".charCodeAt(0), U = ">".charCodeAt(0), L = "@".charCodeAt(0), M = "#".charCodeAt(0), j = "$".charCodeAt(0), V = "\\".charCodeAt(0), B = "/".charCodeAt(0), q = "\n".charCodeAt(0), K = "\r".charCodeAt(0), $ = "\f".charCodeAt(0), G = '"'.charCodeAt(0), W = "'".charCodeAt(0), H = " ".charCodeAt(0), J = "\t".charCodeAt(0), X = ";".charCodeAt(0), Y = ":".charCodeAt(0), Z = "{".charCodeAt(0), Q = "}".charCodeAt(0), ee = "[".charCodeAt(0), te = "]".charCodeAt(0), ne = ",".charCodeAt(0), re = ".".charCodeAt(0), ie = "!".charCodeAt(0), oe = [h, x, d, v, l, y, O, O], se = [h, x, d, v, l, y, A, A, c, w, d, v, o, f, s, g, a, b, p, k, O, O], ae = {};
    ...
    var ce = function () {
        ...
        return e.prototype.setSource = function (e) {
            ...
            if (this.stream.eos())return this.finishToken(t, n.EOF);
            if (this.stream.advanceIfChars([N, ie, A, A]))return this.finishToken(t, n.CDO);
            if (this.stream.advanceIfChars([A, A, U]))return this.finishToken(t, n.CDC);
            var r = this._url();
            if (null !== r)return this.finishToken(t, r);
            var i = [];
            if (this.ident(i))return this.finishToken(t, n.Ident, i.join(""));
            ...
            if (this.stream.advanceIfChar(M))return i = ["#"], this._name(i) ? this.finishToken(t, n.Hash, i.join("")) : this.finishToken(t, n.Delim);
            if (this.stream.advanceIfChar(ie))return this.finishToken(t, n.Exclamation);
            if (this._number()) {
                var s = this.stream.pos();
                if (i = [this.stream.substring(t, s)], this.stream.advanceIfChar(D))return this.finishToken(t, n.Percentage);
                if (this.ident(i)) {
            ...
            if (n === V) {
                ...
                for (var r = 0; r < 6 && (n >= S && n <= F || n >= i && n <= s || n >= u && n <= g);)this.stream.advance(1), n = this.stream.peekChar(), r++;
                if (r > 0) {
                    try {
                ...
                if (n !== K && n !== $ && n !== q)return this.stream.advance(1), e.push(String.fromCharCode(n)), !0;
            ...
            if (this._matchWordAnyCase(oe) || this._matchWordAnyCase(se)) {
                this._whitespace();
                var e = n.URI, t = this._string([]);
                if (t === n.BadString)e = n.BadUri; else if (null === t) {
                    var r = 0;
                    this.stream.advanceWhileChar(function (e) {
                        if (e === O)r++; else if (e === z) {
                            if (0 === r)return !1;
                            r--
                        }
                        return !0
            ...
            var t = this.stream.pos(), n = this._minus(e);
            if (n && this._minus(e)) {
                for (var r = !1; this._identChar(e) || this._escape(e);)r = !0;
                if (r)return !0
...
!function (e) {
    ...
    var a = function () {
        ...
        return Object.defineProperty(e.prototype, "end", {
            ...
            if (this.children)for (var t = null, n = this.children.length - 1; n >= 0; n--)if (t = this.children[n], t.offset <= e)return t;
            return null
    ...
    var X = function (e) {
        ...
        return __extends(t, e), Object.defineProperty(t.prototype, "type", {
            ...
            for (var e, t = this.getText(), n = 0, r = ".".charCodeAt(0), i = "0".charCodeAt(0), o = "9".charCodeAt(0), s = 0, a = t.length; s < a && (e = t.charCodeAt(s), i <= e && e <= o || e === r); s++)n += 1;
    ...
    var n = e("vscode-nls"), r = n.loadMessageBundle(), i = function () {
        function e(e, t) {
    ...
    t.data = {
        css: {
            atdirectives: [{name: "@charset", desc: "Defines character set of the document."}, {
                name: "@counter-style",
            ...
            pseudoelements: [{
                ...
                browsers: "C35,O22"
            }, {name: "::cue", browsers: "C,O16,S6"}, {name: "::cue()", browsers: "C,O16,S6"}, {
                name: "::cue-region",
                browsers: "C,O16,S6"
            ...
            properties: [{
                ...
                values: [{
                    ...
                    name: "center", desc: "The flex item’s margin box is centered in the cross axis within the line."
                }, {
                    name: "flex-end",
                    desc: "The cross-end margin edge of the flex item is placed flush with the cross-end edge of the line."
                }, {
                ...
                restriction: "enum",
                values: [{name: "hidden", desc: "Back side is hidden."}, {
                    name: "visible",
                ...
                restriction: "enum",
                values: [{name: "block"}, {name: "flex", browsers: "E,C29,FF22,IE11,O12.1,S9"}, {
                    name: "flexbox",
                    browsers: "O12.1"
                }, {
                    name: "inline",
                    ...
                    name: "-moz-marker",
                    browsers: "FF"
                }, {name: "-moz-popup", browsers: "FF"}, {name: "-moz-stack", browsers: "FF"}, {
                    name: "-ms-flexbox",
                    browsers: "IE10"
                ...
                }, {name: "content", browsers: "E,IE11"}, {name: "none", desc: "Expands to '0 0 auto'."}]
            }, {
                name: "flex-basis",
                ...
                browsers: "FF34,S9",
                restriction: "enum",
                values: [{name: "none", desc: "Disallow all synthetic faces."}, {name: "style"}, {name: "weight"}]
            }, {
                name: "font-variant",
                ...
                values: [{
                    ...
                    name: "max-content",
                    browsers: "C46,O33"
                }, {name: "min-content", browsers: "C46,O33"}]
            }, {
                ...
                values: [{name: "none", desc: "No limit on the height of the box."}, {
                    name: "fit-content",
                    browsers: "C46,O33"
                }, {name: "max-content", browsers: "C46,O33"}, {name: "min-content", browsers: "C46,O33"}]
            }, {
                ...
                values: [{
                    ...
                    name: "nowrap",
                    desc: "The flex container is single-line."
                }, {name: "row"}, {name: "wrap", desc: "The flexbox is multi-line."}, {name: "wrap-reverse"}]
            }, {
                ...
                name: "-webkit-text-stroke", browsers: "S3", restriction: "length, line-width, color, percentage"
            }, {
    ...
    function a(e) {
        var t = e.description || "", n = this.getBrowserLabel(e.browsers);
        return n && (t && (t += "\n"), t = t + "(" + n + ")"), t
    }
    ...
    function l(e) {
        ...
        for (var r in t.browserNames)if ("string" == typeof e[r]) {
    ...
    function c(e) {
        var n = {all: !1, count: 0, onCodeComplete: !1}, r = 0;
        return e ? e.split(",").forEach(function (e) {
            if (e = e.trim(), "all" === e)n.all = !0, r = Number.MAX_VALUE; else if ("none" !== e)for (var i in t.browserNames)0 === e.indexOf(i) && (n[i] = e.substring(i.length).trim(), r++)
    ...
    var u = e("../parser/cssNodes"), f = e("../data/browsers"), g = e("vscode-nls"), b = g.loadMessageBundle();
    t.colors = {
        aliceblue: "#f0f8ff",
        antiquewhite: "#faebd7",
        aqua: "#00ffff",
    ...
    t.getPseudoClasses = m, t.browserNames = {E: "Edge", FF: "Firefox", S: "Safari", C: "Chrome", IE: "IE", O: "Opera"}
}), function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    ...
    var n = e("./cssScanner"), r = e("./cssNodes"), i = e("./cssErrors"), o = e("../services/languageFacts"), s = function () {
        function e(e) {
        ...
        return e.prototype.peek = function (e, t, n) {
            ...
            var t = e.version, n = function (n, r) {
            ...
            do {
                ...
                do {
                    ...
                    for (s && (e.addChild(s), o = !0, t = !1, this.peek(n.TokenType.EOF) || !this._needsSemicolonAfter(s) || this.accept(n.TokenType.SemiColon) || this.markError(e, i.ParseError.SemiColonExpected)); this.accept(n.TokenType.SemiColon) || this.accept(n.TokenType.CDO) || this.accept(n.TokenType.CDC);)o = !0, t = !1
                } while (o);
            ...
            var t = this.create(r.Selector), n = !1;
            ...
            if (this.peek(n.TokenType.CurlyL)) {
                var o = this.create(r.CustomPropertySet), s = this._parseDeclarations(this._parseRuleSetDeclaration.bind(this));
                if (o.setDeclarations(s) && !s.isErroneous(!0) && (o.addChild(this._parsePrio()), this.peek(n.TokenType.SemiColon)))return this.finish(o), e.setPropertySet(o), e.semicolonPosition = this.token.offset, this.finish(e);
            ...
            var e = this.create(r.Node), t = function () {
                return 0 === o && 0 === s && 0 === a
            }, o = 0, s = 0, a = 0;
            e:for (; ;) {
                switch (this.token.type) {
                    ...
                    case n.TokenType.ParenthesisR:
                        if (s--, s < 0)return this.finish(e, i.ParseError.LeftParenthesisExpected);
                        break;
                    case n.TokenType.BracketL:
                        a++;
                        break;
                    case n.TokenType.BracketR:
                        if (a--, a < 0)return this.finish(e, i.ParseError.LeftSquareBracketExpected);
                        break;
            ...
            var e = this.create(r.Property), t = this.mark();
            ...
            var e = this.create(r.Keyframe), t = this.create(r.Node);
            ...
            for (; this.accept(n.TokenType.Comma);)if (!e.addChild(this._parseIdent()) && !this.accept(n.TokenType.Percentage))return this.finish(e, i.ParseError.PercentageExpected);
            ...
            if (!e.addChild(this._parseMediaQuery([n.TokenType.CurlyL])))return this.finish(e, i.ParseError.IdentifierExpected);
            for (; this.accept(n.TokenType.Comma);)if (!e.addChild(this._parseMediaQuery([n.TokenType.CurlyL])))return this.finish(e, i.ParseError.IdentifierExpected);
            return this._parseBody(e, this._parseMediaDeclaration.bind(this))
        }, e.prototype._parseMediaQuery = function (e) {
            var t = this.create(r.MediaQuery), o = !0, s = !1;
            ...
            for (; o;) {
                if (!this.accept(n.TokenType.ParenthesisL))return s ? this.finish(t, i.ParseError.LeftParenthesisExpected, [], e) : null;
            ...
            if (e.getMediums().addChild(this._parseMedium())) {
                for (; this.accept(n.TokenType.Comma);)if (!e.getMediums().addChild(this._parseMedium()))return this.finish(e, i.ParseError.IdentifierExpected);
                return this.finish(e)
            }
            return null
            ...
            if (e.addChild(this._parsePageSelector()))for (; this.accept(n.TokenType.Comma);)if (!e.addChild(this._parsePageSelector()))return this.finish(e, i.ParseError.IdentifierExpected);
            ...
            var e = this.create(r.SimpleSelector), t = 0;
            ...
            var e = this.mark(), t = this.createNode(r.NodeType.PseudoSelector);
            ...
            var e = this.mark(), t = this.create(r.Function);
            ...
            if (t.getArguments().addChild(this._parseFunctionArgument()))for (; this.accept(n.TokenType.Comma);)t.getArguments().addChild(this._parseFunctionArgument()) || this.markError(t, i.ParseError.ExpressionExpected);
            ...
            if (e.referenceTypes = [r.ReferenceType.Function], this.accept(n.TokenType.Ident, "progid")) {
                if (this.accept(n.TokenType.Colon))for (; this.accept(n.TokenType.Ident) && this.accept(n.TokenType.Delim, "."););
                return this.finish(e)
            }
...
!function (e) {
    ...
    var n = e("./cssNodes"), r = e("../utils/arrays"), i = function () {
        function e(e, t) {
        ...
        return e.prototype.addChild = function (e) {
            ...
            void 0 === t && (t = 0);
            var n = e + t, i = r.findFirst(this.children, function (e) {
                return e.offset > n
            });
            if (0 === i)return this;
    ...
    var a = function () {
        ...
        return e.prototype.addSymbol = function (e, t, n, r) {
            ...
            if (t) {
                var r = e.getDefaultValue(), i = r ? r.getText() : null;
    ...
    var l = function () {
        ...
        return e.prototype.findSymbolsAtOffset = function (e, t) {
            ...
            if (!r || r.indexOf(t.type) === -1)return !1;
    ...
    !function (e) {
        function t(e, t, r, i) {
            if (_.number(e) && _.number(t) && _.number(r) && _.number(i))return {
                start: n.create(e, t),
                end: n.create(r, i)
            };
    ...
    function r(e, t) {
        for (var n = t - 1, r = e.getText(); n >= 0 && ' \t\n\r":{[()]},'.indexOf(r.charAt(n)) === -1;)n--;
        return r.substring(n + 1, t)
    }

    var i = e("../parser/cssNodes"), o = e("../parser/cssSymbolScope"), s = e("./languageFacts"), a = e("../utils/strings"), l = e("vscode-languageserver-types"), c = e("vscode-nls"), d = c.loadMessageBundle(), h = l.InsertTextFormat.Snippet, p = function () {
        function e(e) {
        ...
        return e.prototype.getSymbolContext = function () {
            ...
            for (var n = this.nodePath.length - 1; n >= 0; n--) {
                ...
                if (e.indexOf(r.type) !== -1)return r
            }
            return null
            ...
            for (var n = this, r = e.getFullPropertyName(), i = s.getProperties()[r], o = e.getValue(); o && o.hasChildren();)o = o.findChildAtOffset(this.offset, !1);
            if (i)this.getColorProposals(i, o, t), this.getPositionProposals(i, o, t), this.getRepeatStyleProposals(i, o, t), this.getLineProposals(i, o, t), this.getBoxProposals(i, o, t), this.getImageProposals(i, o, t), this.getTimingFunctionProposals(i, o, t), this.getBasicShapeProposals(i, o, t), this.getValueEnumProposals(i, o, t), this.getCSSWideKeywordProposals(i, o, t), this.getUnitProposals(i, o, t); else {
                var a = new m;
            ...
            for (var r in s.cssWideKeywords)n.items.push({
                label: r,
            ...
            var n = this, r = this.getSymbolContext().findSymbolsAtOffset(this.offset, i.ReferenceType.Variable);
            return r.forEach(function (r) {
                var o = a.startsWith(r.name, "--") ? "var(" + r.name + ")" : r.name, s = {
                    label: r.name,
            ...
            var t = this, n = this.getSymbolContext().findSymbolsAtOffset(this.offset, i.ReferenceType.Variable);
            ...
            if (e.restrictions.indexOf("position") !== -1)for (var r in s.positionKeywords)n.items.push({
                label: r,
            ...
            if (e.restrictions.indexOf("repeat") !== -1)for (var r in s.repeatStyleKeywords)n.items.push({
                label: r,
            ...
            var r = this;
            if (e.restrictions.indexOf("line-style") !== -1)for (var i in s.lineStyleKeywords)n.items.push({
                label: i,
            ...
            if (r !== -1)for (var i in s.geometryBoxKeywords)n.items.push({
                label: i,
                documentation: s.geometryBoxKeywords[i],
                textEdit: l.TextEdit.replace(this.getCompletionRange(t), i),
                kind: l.CompletionItemKind.Value
            });
            if (e.restrictions.indexOf("box") !== -1 || r !== -1)for (var i in s.boxKeywords)n.items.push({
                label: i,
            ...
            if (e.restrictions.indexOf("image") !== -1)for (var r in s.imageFunctions)n.items.push({
                label: r,
            ...
            if (e.restrictions.indexOf("timing-function") !== -1)for (var r in s.transitionTimingFunctions)n.items.push({
                label: r,
            ...
            if (e.restrictions.indexOf("shape") !== -1)for (var r in s.basicShapeFunctions)n.items.push({
                label: r,
            ...
            var n = e.getDeclarations(), r = n && n.endsWith("}") && this.offset >= n.end;
            if (r)return this.getCompletionForTopLevel(t);
            var o = !n || this.offset <= n.offset;
            if (o) {
                for (var s = this.textDocument.offsetAt(this.defaultReplaceRange.start); s > 0 && ":" === this.textDocument.getText().charAt(s - 1);)s--;
            ...
            var n = this, r = this.findInNodePath(i.NodeType.PseudoSelector, i.NodeType.IdentifierSelector, i.NodeType.ClassSelector, i.NodeType.ElementNameSelector);
            ...
            if (!n)return this.getTermProposals(null, t), t;
            ...
            var n = this, r = this.getSymbolContext().findSymbolsAtOffset(this.offset, i.ReferenceType.Mixin);
            ...
            var n = this, r = this.getSymbolContext().findSymbolsAtOffset(this.offset, i.ReferenceType.Function);
            return r.forEach(function (r) {
...
!function (e) {
    ...
    function s(e) {
        ...
        var t = new c, n = [];
        if (e.getParent()instanceof a.RuleSet)for (var r = e.getParent().getParent(); r && !o(r);) {
        ...
        for (var i = new m(t), s = n.length - 1; s >= 0; s--) {
    ...
    var a = e("../parser/cssNodes"), l = function () {
        function e() {
        }
    ...
    var h, p = function () {
        ...
        return e.prototype.print = function (e) {
            ...
            var n = this, r = e.findAttribute("name");
    ...
    var n = e("../parser/cssNodes"), r = e("./languageFacts"), i = e("vscode-languageserver-types"), o = e("./selectorPrinting"), s = function () {
        function e() {
        }
        ...
        return e.prototype.doHover = function (e, t, s) {
            ...
            for (var l = e.offsetAt(t), c = n.getNodePath(s, l), d = 0; d < c.length; d++) {
                var h = c[d];
                if (h instanceof n.Selector)return {contents: o.selectorToMarkedString(h), range: a(h)};
                if (h instanceof n.SimpleSelector)return {contents: o.simpleSelectorToMarkedString(h), range: a(h)};
                if (h instanceof n.Declaration) {
                    var p = h.getFullPropertyName(), m = r.getProperties()[p];
                    if (m) {
                        var u = [];
                        m.description && u.push(i.MarkedString.fromPlainText(m.description));
                        var f = r.getBrowserLabel(m.browsers);
                        if (f && u.push(i.MarkedString.fromPlainText(f)), u.length)return {contents: u, range: a(h)}
                    }
                }
            }
            return null
    ...
    var i = e("../parser/cssNodes"), o = e("vscode-languageserver-types"), s = e("../parser/cssSymbolScope"), a = e("../services/languageFacts"), l = e("vscode-nls"), c = l.loadMessageBundle(), d = function () {
        function e() {
        }

        return e.prototype.findDefinition = function (e, t, r) {
            var a = new s.Symbols(r), l = e.offsetAt(t), c = i.getNodeAtOffset(r, l);
            ...
            var a = [], l = e.offsetAt(t), c = i.getNodeAtOffset(o, l);
            if (!c || c.type === i.NodeType.Stylesheet || c.type === i.NodeType.Declarations)return a;
            var d = new s.Symbols(o), h = d.findSymbolFromNode(c), p = c.getText();
            return o.accept(function (t) {
                if (h) {
                    if (d.matchesSymbol(t, h))return a.push({kind: r(t), range: n(t, e)}), !1
                } else c.type === t.type && c.length === t.length && p === t.getText() && a.push({
                    kind: r(t),
                    range: n(t, e)
                });
                return !0
            ...
            return t.accept(function (t) {
                var s = {name: null, kind: o.SymbolKind.Class, location: null}, a = t;
            ...
            var i = this.findDocumentHighlights(e, t, r), s = i.map(function (e) {
                return o.TextEdit.replace(e.range, n)
            });
            return {changes: [{textDocument: {version: e.version, uri: e.uri}, edits: s}]}
        }, e
    }();
    t.CSSNavigation = d
}), function (e) {
    ...
    var i = e("../parser/cssNodes"), o = e("vscode-nls"), s = o.loadMessageBundle(), a = "warning", l = "error", c = "ignore", d = function () {
        function e(e, t, n) {
    ...
    var n = e("../parser/cssNodes"), r = e("./languageFacts"), i = e("../utils/strings"), o = e("../services/lintRules"), s = e("vscode-languageserver-types"), a = e("vscode-nls"), l = a.loadMessageBundle(), c = function () {
        function e() {
        }
        ...
        return e.prototype.doCodeActions = function (e, t, n, r) {
            ...
            for (var d in r.getProperties()) {
                ...
                h >= a.length / 2 && c.push({property: d, score: h})
            }
            c.sort(function (e, t) {
                return t.score - e.score
            });
            for (var p = 3, m = 0, u = c; m < u.length; m++) {
                var f = u[m], g = f.property, b = l("css.codeaction.rename", "Rename to '{0}'", g), y = s.TextEdit.replace(n.range, g);
                if (o.push(s.Command.create(b, "_css.applyCodeAction", e.uri, e.version, [y])), --p <= 0)return
            }
        }, e.prototype.appendFixesForMarker = function (e, t, r, i) {
            if (r.code === o.Rules.UnknownProperty.id)for (var s = e.offsetAt(r.range.start), a = e.offsetAt(r.range.end), l = n.getNodePath(t, s), c = l.length - 1; c >= 0; c--) {
                var d = l[c];
                if (d instanceof n.Declaration) {
                    var h = d.getProperty();
                    if (h && h.offset === s && h.end === a)return void this.getFixesForUnknownProperty(e, h, r, i)
                }
            }
        }, e
    }();
    ...
    var n = e("./languageFacts"), r = e("./lintRules"), i = e("../parser/cssNodes"), o = e("vscode-nls"), s = o.loadMessageBundle(), a = function () {
        function e(e, t) {
        ...
        function e(e) {
            ...
            for (var t in r.Rules) {
                var n = r.Rules[t], i = e[n.id] || r.toLevel(n.defaultValue);
        ...
        return e.entries = function (t, n) {
            ...
            e.accept(function (e) {
                if (e instanceof i.Keyframe) {
                    var t = e.getKeyword(), r = t.getText();
                    n.add(e.getName(), r, "@keyframes" !== r ? t : null)
                }
                return !0
            });
            var o = ["@-webkit-keyframes", "@-moz-keyframes", "@-o-keyframes"], a = function (e) {
                var i = n.data[e].names, a = i.indexOf("@keyframes") === -1;
                if (!a && 1 === i.length)return "continue";
                var l = function (e) {
                    if (a) {
            ...
            var o = this, c = t.getDeclarations();
            if (!c)return !1;
            ...
            if (c.getChildren().forEach(function (e) {
                ...
                if (b.length > 0) {
                    ...
                    if (["border", "border-top", "border-bottom", "padding", "padding-top", "padding-bottom"].forEach(function (e) {
                        ...
                        }), y)for (var w = 0, v = b; w < v.length; w++) {
                        var x = v[w];
            ...
            if (k.length > 0 && ["width", "height", "margin-top", "margin-bottom", "float"].forEach(function (e) {
                    for (var t = d.fetch(h, e), n = 0; n < t.length; n++)d.addEntry(t[n].node, r.Rules.PropertyIgnoredDueToDisplay, s("rule.propertyIgnoredDueToDisplayInline", "Property is ignored due to the display. With 'display: inline', the width, height, margin-top, margin-bottom, and float properties have no effect."))
                }), k = this.fetchWithValue(h, "display", "inline-block"), k.length > 0)for (var T = this.fetch(h, "float"), S = 0; S < T.length; S++)this.addEntry(T[S].node, r.Rules.PropertyIgnoredDueToDisplay, s("rule.propertyIgnoredDueToDisplayInlineBlock", "Property is ignored due to the display. With 'display: inline-block', float properties have no effect."));
            if (k = this.fetchWithValue(h, "display", "block"), k.length > 0)for (var T = this.fetch(h, "vertical-align"), S = 0; S < T.length; S++)this.addEntry(T[S].node, r.Rules.PropertyIgnoredDueToDisplay, s("rule.propertyIgnoredDueToDisplayBlock", "Property is ignored due to the display. With 'display: block', vertical-align should not be used."));
            t.accept(function (e) {
                return e.type === i.NodeType.Prio && d.addEntry(e, r.Rules.AvoidImportant), !0
            });
            for (var F = this.fetch(h, "float"), S = 0; S < F.length; S++)this.addEntry(F[S].node, r.Rules.AvoidFloat);
            for (var C = 0; C < h.length; C++) {
                ...
                if ("background" !== E.name.toLowerCase()) {
                    ...
                    if (I && "-" !== I.getText()[0]) {
                        ...
                        if (P.length > 1)for (var A = 0; A < P.length; A++) {
            ...
            if (c.getChildren().forEach(function (e) {
                    if (o.isCSSDeclaration(e)) {
                        var t = e, i = t.getFullPropertyName(), s = i.charAt(0);
                        if ("-" === s) {
                            if ("-" !== i.charAt(1)) {
                        ...
                        } else"*" !== s && "_" !== s || (o.addEntry(t.getProperty(), r.Rules.IEStarHack), i = i.substr(1)), n.isKnownProperty(i) || o.addEntry(t.getProperty(), r.Rules.UnknownProperty), D.add(i, i, null)
                    } else R = !0
                }), !R) {
                var O = function (t) {
                    var i = D.data[t], a = i.names, l = n.isKnownProperty(t) && a.indexOf(t) === -1;
                    if (!l && 1 === a.length)return "continue";
                    for (var c = [], d = 0, h = e.prefixes.length; d < h; d++) {
                        var p = e.prefixes[d];
            ...
            var t = this, n = e.getDeclarations();
            if (n) {
                var i = !1, o = !1, s = !1;
            ...
            var t = e.getName().toLowerCase(), n = -1, o = 0;
            switch (t) {
                case"rgb(":
                case"hsl(":
                    n = 3;
    ...
    var n = e("../parser/cssNodes"), r = e("vscode-languageserver-types"), i = e("./lintRules"), o = e("./lint"), s = function () {
        function e() {
        }
...
!function (e) {
    ...
    var n = e("./cssScanner"), r = "/".charCodeAt(0), i = "\n".charCodeAt(0), o = "\r".charCodeAt(0), s = "\f".charCodeAt(0), a = "$".charCodeAt(0), l = "#".charCodeAt(0), c = "{".charCodeAt(0), d = "=".charCodeAt(0), h = "!".charCodeAt(0), p = "<".charCodeAt(0), m = ">".charCodeAt(0), u = ".".charCodeAt(0), f = n.TokenType.CustomToken;
    ...
    var g = function (e) {
        ...
        return __extends(f, e), f.prototype.scan = function () {
            ...
            if (this.stream.advanceIfChar(a)) {
                var o = ["$"];
                if (this.ident(o))return this.finishToken(i, t.VariableName, o.join(""));
...
!function (e) {
    ...
    var n = e("./scssScanner"), r = e("./cssScanner"), i = e("./cssParser"), o = e("./cssNodes"), s = e("./scssErrors"), a = e("./cssErrors"), l = function (e) {
        function t() {
        ...
        return __extends(t, e), t.prototype._parseStylesheetStatement = function () {
            ...
            if (!this.accept(r.TokenType.URI) && !this.accept(r.TokenType.String))return this.finish(e, a.ParseError.URIOrStringExpected);
            for (; this.accept(r.TokenType.Comma);)if (!this.accept(r.TokenType.URI) && !this.accept(r.TokenType.String))return this.finish(e, a.ParseError.URIOrStringExpected);
            ...
            if (!this.accept(r.TokenType.Colon, ":"))return this.finish(t, a.ParseError.ColonExpected, [r.TokenType.Colon], e);
            t.colonPosition = this.prevToken.offset;
            var n = !1;
            if (t.setValue(this._parseExpr()) && (n = !0, t.addChild(this._parsePrio())), this.peek(r.TokenType.CurlyL))t.setNestedProperties(this._parseNestedProperties()); else if (!n)return this.finish(t, a.ParseError.PropertyValueExpected);
            ...
            if (!this.peek(r.TokenType.AtKeyword, "@debug") && !this.peek(r.TokenType.AtKeyword, "@warn"))return null;
            ...
            if (this._parseBody(t, e), this.accept(r.TokenType.AtKeyword, "@else"))if (this.peek(r.TokenType.Ident, "if"))t.setElseClause(this._internalParseIfStatement(e)); else if (this.peek(r.TokenType.CurlyL)) {
            ...
            for (; this.accept(r.TokenType.Comma);)if (!n.addChild(this._parseVariable()))return this.finish(t, a.ParseError.VariableNameExpected, [r.TokenType.CurlyR]);
            ...
            if (this.consumeToken(), !e.setIdentifier(this._parseIdent([o.ReferenceType.Function])))return this.finish(e, a.ParseError.IdentifierExpected, [r.TokenType.CurlyR]);
            if (!this.accept(r.TokenType.ParenthesisL))return this.finish(e, a.ParseError.LeftParenthesisExpected, [r.TokenType.CurlyR]);
            if (e.getParameters().addChild(this._parseParameterDeclaration()))for (; this.accept(r.TokenType.Comma);)if (!e.getParameters().addChild(this._parseParameterDeclaration()))return this.finish(e, a.ParseError.VariableNameExpected);
            ...
            if (this.consumeToken(), !e.setIdentifier(this._parseIdent([o.ReferenceType.Mixin])))return this.finish(e, a.ParseError.IdentifierExpected, [r.TokenType.CurlyR]);
            if (this.accept(r.TokenType.ParenthesisL)) {
                if (e.getParameters().addChild(this._parseParameterDeclaration()))for (; this.accept(r.TokenType.Comma);)if (!e.getParameters().addChild(this._parseParameterDeclaration()))return this.finish(e, a.ParseError.VariableNameExpected);
                if (!this.accept(r.TokenType.ParenthesisR))return this.finish(e, a.ParseError.RightParenthesisExpected, [r.TokenType.CurlyR])
            }
            return this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
            ...
            if (this.consumeToken(), !e.setIdentifier(this._parseIdent([o.ReferenceType.Mixin])))return this.finish(e, a.ParseError.IdentifierExpected, [r.TokenType.CurlyR]);
            if (this.accept(r.TokenType.ParenthesisL)) {
                if (e.getArguments().addChild(this._parseFunctionArgument()))for (; this.accept(r.TokenType.Comma);)if (!e.getArguments().addChild(this._parseFunctionArgument()))return this.finish(e, a.ParseError.ExpressionExpected);
            ...
            var e = this.create(o.FunctionArgument), t = this.mark(), i = this._parseVariable();
            if (i)if (this.accept(r.TokenType.Colon))e.setIdentifier(i); else {
...
!function (e) {
    ...
    var n = e("./cssCompletion"), r = e("vscode-languageserver-types"), i = e("vscode-nls"), o = i.loadMessageBundle(), s = function (e) {
        function t() {
...
!function (e) {
    ...
    var n = e("./cssScanner"), r = "/".charCodeAt(0), i = "\n".charCodeAt(0), o = "\r".charCodeAt(0), s = "\f".charCodeAt(0), a = "`".charCodeAt(0), l = ".".charCodeAt(0), c = n.TokenType.CustomToken;
    t.Ellipsis = c++;
    var d = function (e) {
        function c() {
            return null !== e && e.apply(this, arguments) || this
        ...
        return __extends(c, e), c.prototype.scan = function () {
            var n = this.trivia();
            if (null !== n)return n;
            var r = this.stream.pos(), i = this.escapedJavaScript();
...
!function (e) {
    ...
    var n = e("./lessScanner"), r = e("./cssScanner"), i = e("./cssParser"), o = e("./cssNodes"), s = e("./cssErrors"), a = function (e) {
        function t() {
        ...
        return __extends(t, e), t.prototype._parseStylesheetStatement = function () {
            ...
            if (this.accept(r.TokenType.ParenthesisL)) {
                ...
                do if (!this.accept(r.TokenType.Comma))break; while (this.accept(r.TokenType.Ident));
                if (!this.accept(r.TokenType.ParenthesisR))return this.finish(e, s.ParseError.RightParenthesisExpected, [r.TokenType.SemiColon])
            }
            ...
            void 0 === e && (e = []);
            var t = this.create(o.VariableDeclaration), n = this.mark();
            ...
            for (var e = this.create(o.Variable), t = this.mark(); this.accept(r.TokenType.Delim, "@");)if (this.hasWhitespace())return this.restoreAtMark(t), null;
            ...
            var n = this.mark(), r = this.create(o.Selector);
            ...
            var e = this.mark(), t = this.create(o.MixinDeclaration);
            ...
            if (t.getParameters().addChild(this._parseMixinParameter()))for (; (this.accept(r.TokenType.Comma) || this.accept(r.TokenType.SemiColon)) && !this.peek(r.TokenType.ParenthesisR);)if (!t.getParameters().addChild(this._parseMixinParameter()))return this.finish(t, s.ParseError.IdentifierExpected);
            ...
            var t = this.mark(), n = this.create(o.ExtendsReference);
            ...
            var e = this.mark(), t = this.create(o.ExtendsReference);
            ...
            var e = this.mark(), t = this.create(o.MixinReference);
            ...
            if (!this.hasWhitespace() && this.accept(r.TokenType.ParenthesisL)) {
                if (n.getArguments().addChild(this._parseMixinArgument()))for (; (this.accept(r.TokenType.Comma) || this.accept(r.TokenType.SemiColon)) && !this.peek(r.TokenType.ParenthesisR);)if (!n.getArguments().addChild(this._parseMixinArgument()))return this.finish(n, s.ParseError.ExpressionExpected);
            ...
            var e = this.create(o.FunctionArgument), t = this.mark(), n = this._parseVariable();
            ...
            if (this.consumeToken(), e.isNegated = this.accept(r.TokenType.Ident, "not"), !e.getConditions().addChild(this._parseGuardCondition()))return this.finish(e, s.ParseError.ConditionExpected);
            for (; this.accept(r.TokenType.Ident, "and") || this.accept(r.TokenType.Comma, ",");)if (!e.getConditions().addChild(this._parseGuardCondition()))return this.finish(e, s.ParseError.ConditionExpected);
            return this.finish(e)
...
!function (e) {
    ...
    s.builtInProposals = [{
        ...
        name: "round", description: o("less.builtin.round", "rounds a number to a number of places"),
    ...
    }, {name: "negation", example: "negation(@color1, @color2);"}], t.LESSCompletion = s
}), function (e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    ...
    var s = e("./parser/cssParser"), a = e("./services/cssCompletion"), l = e("./services/cssHover"), c = e("./services/cssNavigation"), d = e("./services/cssCodeActions"), h = e("./services/cssValidation"), p = e("./parser/scssParser"), m = e("./services/scssCompletion"), u = e("./parser/lessParser"), f = e("./services/lessCompletion");
    ...
    var r = monaco.Promise, i = e("vscode-css-languageservice"), o = e("vscode-languageserver-types"), s = function () {
        function e(e, t) {
        ...
        return e.prototype.doValidation = function (e) {
            var t = this._getTextDocument(e), n = this._languageService.parseStylesheet(t), i = this._languageService.doValidation(t, n);
            return r.as(i)
        }, e.prototype.doComplete = function (e, t) {
            var n = this._getTextDocument(e), i = this._languageService.parseStylesheet(n), o = this._languageService.doComplete(n, t, i);
            return r.as(o)
        }, e.prototype.doHover = function (e, t) {
            var n = this._getTextDocument(e), i = this._languageService.parseStylesheet(n), o = this._languageService.doHover(n, t, i);
            return r.as(o)
        }, e.prototype.findDefinition = function (e, t) {
            var n = this._getTextDocument(e), i = this._languageService.parseStylesheet(n), o = this._languageService.findDefinition(n, t, i);
            return r.as(o)
        }, e.prototype.findReferences = function (e, t) {
            var n = this._getTextDocument(e), i = this._languageService.parseStylesheet(n), o = this._languageService.findReferences(n, t, i);
            return r.as(o)
        }, e.prototype.findDocumentHighlights = function (e, t) {
            var n = this._getTextDocument(e), i = this._languageService.parseStylesheet(n), o = this._languageService.findDocumentHighlights(n, t, i);
            return r.as(o)
        }, e.prototype.findDocumentSymbols = function (e) {
            var t = this._getTextDocument(e), n = this._languageService.parseStylesheet(t), i = this._languageService.findDocumentSymbols(t, n);
            return r.as(i)
        }, e.prototype.doCodeActions = function (e, t, n) {
            var i = this._getTextDocument(e), o = this._languageService.parseStylesheet(i), s = this._languageService.doCodeActions(i, t, n, o);
            return r.as(s)
        }, e.prototype.findColorSymbols = function (e) {
            var t = this._getTextDocument(e), n = this._languageService.parseStylesheet(t), i = this._languageService.findColorSymbols(t, n);
            return r.as(i)
        }, e.prototype.doRename = function (e, t, n) {
            var i = this._getTextDocument(e), o = this._languageService.parseStylesheet(i), s = this._languageService.doRename(i, t, n, o);
            return r.as(s)
