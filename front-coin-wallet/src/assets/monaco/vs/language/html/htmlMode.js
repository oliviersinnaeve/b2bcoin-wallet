...
!function (e) {
    ...
    !function (e) {
        ...
        e.create = t, e.is = n
    }(f = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {}));
    var l;
    !function (e) {
        function t(e, t) {
        ...
        e.create = t, e.is = n
    }(l = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {}));
    var g;
    !function (e) {
        function t(e, t, n, r) {
        ...
        e.create = t, e.is = n
    }(g = t.TextDocumentItem || (t.TextDocumentItem = {}));
    var m;
    !function (e) {
    ...
    }(p = t.InsertTextFormat || (t.InsertTextFormat = {}));
    var h;
    !function (e) {
        function t(e) {
            return {label: e}
        ...
        e.create = t
    }(h = t.CompletionItem || (t.CompletionItem = {}));
    var v;
    !function (e) {
        function t(e, t) {
    ...
    !function (e) {
        ...
        e.create = t, e.is = n
    }(E = t.TextDocument || (t.TextDocument = {}));
    var M;
    !function (e) {
        e.Manual = 1, e.AfterDelay = 2, e.FocusOut = 3
    }(M = t.TextDocumentSaveReason || (t.TextDocumentSaveReason = {}));
    var K, P = function () {
        function e(e, t, n, r) {
    ...
    var l = e("vscode-languageserver-types"), g = (monaco.Uri, monaco.Range), m = function () {
        function e(e, t) {
            var n = this;
            ...
            var r = function (e) {
                ...
                var t = e.uri.toString(), r = n._listener[t];
            ...
            return f(n, this._worker(r).then(function (e) {
                ...
                if (e) {
                    var t = e.items.map(function (e) {
                        ...
                        return e.textEdit && (t.range = a(e.textEdit.range), t.insertText = e.textEdit.newText), e.insertTextFormat === l.InsertTextFormat.Snippet && (t.insertText = {value: t.insertText}), t
                    });
