...
define("vs/basic-languages/src/css", ["require", "exports"], function (e, t) {
    ...
    var n = "tag", i = "tag", r = "attribute.name", o = "attribute.value", a = "keyword";
    t.language = {
        defaultToken: "",
        tokenPostfix: ".css",
        ws: "[ \t\n\r\f]*",
        ...
        tokenizer: {
            ...
            selector: [{include: "@comments"}, {include: "@import"}, {include: "@strings"}, ["[@](keyframes|-webkit-keyframes|-moz-keyframes|-o-keyframes)", {
            ...
            }], ["[@](page|content|font-face|-moz-document)", {token: a}], ["[@](charset|namespace)", {
                token: a,
                ...
                token: "delimiter.parenthesis",
                next: "@urldeclaration"
            }]], {include: "@selectorname"}, ["[\\*]", i], ["[>\\+,]", "delimiter"], ["\\[", {
                token: "delimiter.bracket",
                next: "@selectorattribute"
            }], ["{", {token: "delimiter.bracket", next: "@selectorbody"}]],
            selectorbody: [{include: "@comments"}, ["[*_]?@identifier@ws:(?=(\\s|\\d|[^{;}]*[;}]))", r, "@rulevalue"], ["}", {
                token: "delimiter.bracket",
                next: "@pop"
            }]],
            selectorname: [["(\\.|#(?=[^{])|%|(@identifier)|:)+", n]],
            ...
            term: [{include: "@comments"}, ["(url-prefix)(\\()", ["attribute.value", {
                ...
                token: "delimiter.parenthesis",
                next: "@urldeclaration"
            }]], {include: "@functioninvocation"}, {include: "@numbers"}, {include: "@name"}, ["([<>=\\+\\-\\*\\/\\^\\|\\~,])", "delimiter"], [",", "delimiter"]],
            rulevalue: [{include: "@comments"}, {include: "@strings"}, {include: "@term"}, ["!important", "keyword"], [";", "delimiter", "@pop"], ["(?=})", {
                token: "",
                next: "@pop"
            }]],
            warndebug: [["[@](warn|debug)", {token: a, next: "@declarationbody"}]],
            "import": [["[@](import)", {token: a, next: "@declarationbody"}]],
            ...
            functionarguments: [["\\$@identifier@ws:", r], ["[,]", "delimiter"], {include: "@term"}, ["\\)", {
