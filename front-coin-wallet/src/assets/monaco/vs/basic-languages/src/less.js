...
define("vs/basic-languages/src/less", ["require", "exports"], function (e, t) {
    ...
    var n = "tag", i = "tag", r = "attribute.name", s = "attribute.value";
    t.language = {
        defaultToken: "",
        tokenPostfix: ".less",
        ...
        tokenizer: {
            root: [{include: "@nestedJSBegin"}, ["[ \\t\\r\\n]+", ""], {include: "@comments"}, {include: "@keyword"}, {include: "@strings"}, {include: "@numbers"}, ["[*_]?[a-zA-Z\\-\\s]+(?=:.*(;|(\\\\$)))", r, "@attribute"], ["url(\\-prefix)?\\(", {
                token: "tag",
                next: "@urldeclaration"
            }], ["[{}()\\[\\]]", "@brackets"], ["[,:;]", "delimiter"], ["#@identifierPlus", n + ".id"], ["&", i], ["\\.@identifierPlus(?=\\()", n + ".class", "@attribute"], ["\\.@identifierPlus", n + ".class"], ["@identifierPlus", i], {include: "@operators"}, ["@(@identifier(?=[:,\\)]))", "variable", "@attribute"], ["@(@identifier)", "variable"], ["@", "key", "@atRules"]],
            ...
            attribute: [{include: "@nestedJSBegin"}, {include: "@comments"}, {include: "@strings"}, {include: "@numbers"}, {include: "@keyword"}, ["[a-zA-Z\\-]+(?=\\()", s, "@attribute"], [">", "operator", "@pop"], ["@identifier", s], {include: "@operators"}, ["@(@identifier)", "variable"], ["[)\\}]", "@brackets", "@pop"], ["[{}()\\[\\]>]", "@brackets"], ["[;]", "delimiter", "@pop"], ["[,=:]", "delimiter"], ["\\s", ""], [".", s]],
            ...
            units: [["(em|ex|ch|rem|vmin|vmax|vw|vh|vm|cm|mm|in|px|pt|pc|deg|grad|rad|turn|s|ms|Hz|kHz|%)?", s + ".unit", "@pop"]],
            strings: [['~?"', {
